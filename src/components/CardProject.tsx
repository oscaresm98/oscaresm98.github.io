...
export default function CardProject({pj}: cardProjectProps) {
  return (
    <Link to={pj.url} className="rounded-lg bg-[#1E293B] p-4 shadow-md transition-all hover:scale-105 hover:shadow-lg focus:outline-none duration-1000 focus:ring-2 focus:ring-principal focus:ring-offset-2 flex flex-col items-center">
      <img
